...
# License : GPL v2.0
# Last update : Tue, 10 Aug 2021 22:22:13 +0430
...
# ADD CONFIGURATION TO /etc/ldap.conf FILE # ------------------------------------------------------------------------------------------------------------------- #
...
echo "port 636"                                  >> /etc/ldap.conf
echo "pam_password md5"                          >> /etc/ldap.conf
echo "ssl start_tls"                             >> /etc/ldap.conf
echo "ssl on"                                    >> /etc/ldap.conf

# --------------------------------------------------------------------------------------------------------------------------------------------------------- #

# ADD CONFIGURATION TO /etc/ldap/ldap.conf----------------------------------------------------------------------------------------------------------------- #
